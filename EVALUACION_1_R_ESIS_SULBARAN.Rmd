---
title: "Patrones de las aplicaciones exitosas en Google Play Store"  # Título del documento
author: "Enrique Esis"  # Autor del documento
date: "15 de junio de 2024"  # Fecha del documento
output:  # Especificación de los formatos de salida del documento
  #pdf_document:
    #toc: true  # Incluir tabla de contenidos (TOC)
    #toc_depth: 3  # Profundidad de la tabla de contenidos en el documento PDF (hasta el nivel 3)
    #latex_engine: xelatex  # Usar xelatex para mejor soporte de Unicode y fuentes
    #includes:
      #in_header: header.tex  # Incluir archivo LaTeX personalizado
  html_document:  # Configuración para la salida en formato HTML
    toc: true  # Incluir tabla de contenidos (TOC)
    toc_depth: 3  # Profundidad de la tabla de contenidos en el documento HTML (hasta el nivel 3)
    toc_float:  # Configuración para la TOC flotante en HTML
      collapsed: true  # Colapsar la TOC por defecto
      smooth_scroll: true  # Habilitar el desplazamiento suave al hacer clic en los enlaces de la TOC
    theme: journal  # Tema visual para el documento HTML
    highlight: kate  # Esquema de resaltado de sintaxis para el código
    df_print: paged  # Método de impresión de dataframes (tablas) en HTML, con paginación
    code_folding: show  # Mostrar plegado de código por defecto
    fig_height: 4  # Altura de las figuras en el documento (en pulgadas)
    fig_width: 6  # Ancho de las figuras en el documento (en pulgadas)
    number_sections: true  # Numerar las secciones del documento
    self_contained: true  # Incluir todos los recursos en el mismo archivo HTML
    lang: es-ES  # Idioma del documento HTML (Español - España)
---
